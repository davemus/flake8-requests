...
from r2c_flake8_requests.constants import REQUESTS_API_HTTP_VERBS, REQUESTS_API_TOP_LEVEL, MODULE_NAME
...
class MethodVisitor(ast.NodeVisitor):
    ...
    def method_names(self) -> Set[str]:
        ...
        return set(list(REQUESTS_API_TOP_LEVEL) + list(REQUESTS_API_HTTP_VERBS))
